...
public class ModItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        getOrCreateTagBuilder(ItemTags.LOGS_THAT_BURN)
                ...
                .add(ModBlocks.MPINGO_LOG.asItem())
                .add(ModBlocks.MPINGO_WOOD.asItem())
                .add(ModBlocks.STRIPPED_MPINGO_LOG.asItem())
                .add(ModBlocks.STRIPPED_MPINGO_WOOD.asItem());

        getOrCreateTagBuilder(ItemTags.PLANKS)
                .add(ModBlocks.CHESTNUT_PLANKS.asItem())
                .add(ModBlocks.MPINGO_PLANKS.asItem())
